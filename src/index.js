...
const MSGS = {
  INCREASE_NUMBER: "Increase",
  DECREASE_NUMBER: "Decrease",
...
function view(dispatch, model) {
  return div({ className: "flex flex-col gap-4 items-center" }, [
    ...
    button({ className: btnStyle, onclick: () => dispatch(MSGS.INCREASE_NUMBER) }, "Increase"),
    button({ className: btnStyle, onclick: () => dispatch(MSGS.DECREASE_NUMBER) }, "Decrease"),
...
function update(msg, model) {
  switch (msg) {
    case MSGS.INCREASE_NUMBER:
      return { ...model, counter: model.counter + 1 };

    case MSGS.DECREASE_NUMBER:
      return { ...model, counter: model.counter - 1 };
    default:
      return model;
  }
